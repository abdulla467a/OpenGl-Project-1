...
//////////////////////
       glEnable(GL_DEPTH_TEST);
        ...
        char string[64];
        sprintf(string, "Abdulla al shaykat(Fourth year)");
        ...
        sprintf(string, "Daffodil");
        printtext(550,280,string);
        sprintf(string, "International ");
        printtext(550,240,string);
        sprintf(string, "University");
        printtext(550,200,string);
...
//////////////////////
       glEnable(GL_DEPTH_TEST);
        ...
        char string[64];
        sprintf(string, "   B O R N      T O     L E A D");
        printtext(350,640,string);
        glutSwapBuffers();
/////////////////////
...
/////////////////////////////////////           sudo love LINUX
        ...
        char string[64];
        sprintf(string, "D r e a m B i g");
...
//////////////////////
       glEnable(GL_DEPTH_TEST);
        ...
        char string[64];
        sprintf(string, " E N D       O F      L I F E");
        printtext(250,640,string);
         glutSwapBuffers();
...
int main(int argc, char** argv)
{
    ...
    glutCreateWindow("Life Cycle - By Abdulla al shaykat"); //creates window
   //  glutDisplayFunc(dis);
